...
async def begin(call):
    with open('photo_2.jpg', 'rb') as img:
        await call.message.answer_photo(img, texst.congratulations_text, parse_mode=types.ParseMode.HTML, reply_markup=begin_kb)
        await call.answer()

@dp.callback_query_handler(text='watch_lesson')
async def begin(call):
    with open('photo_3.jpg', 'rb') as img:
        await call.message.answer_photo(img, texst.lesson_1_text, parse_mode=types.ParseMode.HTML, reply_markup=watch_lesson_kb)
        await call.answer()

@dp.callback_query_handler(text='next_block_1')
async def next_block_1(call):
    with open('photo_4.jpg', 'rb') as img:
        await call.message.answer_photo(img, texst.prize_text, parse_mode=types.ParseMode.HTML, reply_markup=next_block_1_kb)
        await call.answer()

@dp.callback_query_handler(text='watch_lesson_2')
async def watch_lesson_2(call):
    with open('photo_5.jpg', 'rb') as img:
        await call.message.answer_photo(img, texst.lesson_2_text, parse_mode=types.ParseMode.HTML, reply_markup=watch_lesson_2_kb)
        await call.answer()

@dp.callback_query_handler(text='next_block_2')
async def next_block_2(call):
    with open('photo_6.jpg', 'rb') as img:
        await call.message.answer_photo(img, texst.wow_text, parse_mode=types.ParseMode.HTML, reply_markup=next_block_2_kb)
        await call.answer()

@dp.callback_query_handler(text='watch_lesson_3')
async def get_gift(call):
    with open('photo_7.jpg', 'rb') as img:
        await call.message.answer_photo(img, texst.lesson_3_text, parse_mode=types.ParseMode.HTML, reply_markup=watch_lesson_3_kb)
        await call.answer()

@dp.callback_query_handler(text='next_block_3')
async def get_gift(call):
    with open('photo_8.jpg', 'rb') as img:
        await call.message.answer_photo(img, f'<b>{call.from_user.username},</b>' + texst.finish_text, parse_mode=types.ParseMode.HTML, reply_markup=next_block_3_kb)
        await call.answer()
