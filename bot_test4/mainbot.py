...
async def start(message: types.Message):
    ...
    with open('photo_1.jpg', 'rb') as img:
        new_message = await message.answer_photo(img, f'{message.from_user.full_name},' + texst.start_text_1, parse_mode=types.ParseMode.HTML, reply_markup=start_kb)
...
async def back_list_1(call):
    ...
    with open('photo_1.jpg', 'rb') as img:
        new_message = await call.message.answer_photo(img, f'{call.from_user.full_name},' + texst.start_text_1,
